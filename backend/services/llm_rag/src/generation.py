    ...
    def generate_response(
        ...
        if is_vietnamese:
            system_prompt = (
                ...
                "Bạn là MindCare AI — trợ lý hỗ trợ sức khỏe tâm thần thông tuệ, thấu cảm và không phán xét.\n\n"
                ...
                "ĐỊNH DẠNG PHẢN HỒI:\n"
                "  • Độ dài: 3-5 đoạn văn ngắn (không quá 300 từ).\n"
                "  • Bắt đầu bằng việc ghi nhận cảm xúc của người dùng (câu cảm thông).\n"
                "  • Đề xuất 1-2 kỹ thuật / hành động cụ thể phù hợp với mức độ và vấn đề.\n"
        ...
        # -- English prompt --
            ...
            system_prompt = (
                ...
                "RESPONSE FORMAT:\n"
                "  * Length: 3-5 short paragraphs (max ~250 words).\n"
                "  * Always open with an empathy statement acknowledging what the user shared.\n"
                "  * Suggest 1-2 concrete techniques or actions tailored to their severity and concern.\n"
