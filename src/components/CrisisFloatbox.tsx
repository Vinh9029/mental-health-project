      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-1/2 translate-y-1/2 left-1/2 z-50 w-[90%] max-w-md bg-destructive text-destructive-foreground p-6 rounded-2xl shadow-2xl border border-destructive-foreground/20"
          >
            <button 
              onClick={onClose}
